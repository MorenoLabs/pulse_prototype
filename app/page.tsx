        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1
                  className="text-2xl font-semibold text-[#191919] tracking-tight"
                  style={{ fontFamily: "Lausanne, Helvetica, sans-serif", fontWeight: 600 }}
                >
                  NumaPulse
                </h1>
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <aside className="w-64 bg-white border-r border-gray-100 min-h-screen">
          <nav className="p-6 space-y-2">
            ...
            <Button
              variant={activeTab === "stress-action-report" ? "default" : "ghost"}
              className={`w-full justify-start text-left ${
                activeTab === "stress-action-report"
                  ? "bg-[#ffc9d2] text-[#191919] hover:bg-[#ffc9d2]/90"
                  : "text-gray-700 hover:bg-gray-50"
              }`}
              onClick={() => setActiveTab("stress-action-report")}
              style={{ fontFamily: "Lausanne, Helvetica, sans-serif", fontWeight: 300 }}
            >
            ...
            <Button
              variant={activeTab === "gm-center" ? "default" : "ghost"}
              className={`w-full justify-start text-left ${
                activeTab === "gm-center"
                  ? "bg-[#ffc9d2] text-[#191919] hover:bg-[#ffc9d2]/90"
                  : "text-gray-700 hover:bg-gray-50"
              }`}
              onClick={() => setActiveTab("gm-center")}
              style={{ fontFamily: "Lausanne, Helvetica, sans-serif", fontWeight: 300 }}
            >
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <Card className="border-gray-100 shadow-sm">
                  ...
                  <CardContent>
                    <div
                      className="text-3xl font-semibold text-red-600 mb-1"
                      style={{ fontFamily: "Lausanne, Helvetica, sans-serif", fontWeight: 600 }}
                    >
                  ...
                  <div className="grid grid-cols-4 gap-6">
                    {Object.entries(stressDistribution).map(([category, count]) => (
                      <div key={category} className="text-center">
                        ...
                        <p
                          className="text-sm font-medium text-[#191919] mb-1"
                          style={{ fontFamily: "Lausanne, Helvetica, sans-serif", fontWeight: 600 }}
                        >
                          {category}
                        </p>
